...
test('standalone UX layer provides scroll, glass and a robust language control', () => {
  ...
  assert.match(ux, /window\.nrApp\.setLanguage/);
  assert.match(ux, /Chinese \(Simplified\)/);
